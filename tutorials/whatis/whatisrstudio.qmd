...
people use it through RStudio. RStudio is a user-friendly interface that
makes coding easier.
...
R is. RStudio is the dashboard you're typing in and looking at, but it sends your code to R. R then executes it and computes the result. If R wasn't installed, RStudio would have
