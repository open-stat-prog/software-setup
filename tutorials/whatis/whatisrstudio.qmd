...
R is. RStudio is the dashboard you're typing in and looking at, but it sends your code to R. R then executes it and computes the result. If R weren't installed, RStudio would have
